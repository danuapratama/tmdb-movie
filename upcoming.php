...
<section class="pb-5 mt-5">
    <span class="display-6 d-block mb-4">Up Coming Movies</span>
    <div id="tampil" class="row justify-content-start">
        ...
        <!----------- MOVIE PAGE 1 ------------->
        <?php foreach ($up_coming1['results'] as $row) {
        ?>
        ...
        <div id="load" class="row justify-content-start more-movie">
            <!-------------- MOVIE PAGE 2 ----------------->
            <?php foreach ($up_coming2['results'] as $row) {
            ?>
                <div class="col-lg-3 col-sm-6 mb-5">
                    <div class="card h-100 kartu-film p-2 rounded-3 border-0">
                        <div class="overflow-hidden rounded-top">
            ...
            <!-------------- MOVIE PAGE 3 ----------------->
            <?php foreach ($up_coming3['results'] as $row) {
            ?>
                <div class="col-lg-3 col-sm-6 mb-5">
                    <div class="card h-100 kartu-film p-2 rounded-3 border-0">
                        <div class="overflow-hidden rounded-top">
